...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    ASTERISK = 261,
    RENAME_REF = 262,
    SQUARE_BRACKETED = 263,
    BRACKETED = 264,
    CURLY_BRACKETED = 265,
    ANGLE_BRACKETED = 266,
    SOURCE_NAME = 267,
    FILENO = 268,
    START_LINE_CHAR_COL = 269,
    LINE_CHAR_COL = 270,
    SUBUNIT = 271,
    ENTITY = 272,
    INTEGER = 273
...
{
       0,    77,    77,    80,    82,    81,    88,    87,   100,   101,
     104,   117,   118,   119,   120,   124,   125,   130,   131,   135,
     134,   146,   147,   147,   151,   150,   164,   165,   168,   180,
     192,   193,   196,   197,   200,   201,   203,   204,   207,   208,
     209
};
#endif
...
{
  "$end", "error", "$undefined", "RUBBISH", "DLETTER", "XLETTER",
  "ASTERISK", "RENAME_REF", "SQUARE_BRACKETED", "BRACKETED",
...
#line 1430 "ourxref.tab.c"
    break;

  case 15:
#line 124 "ourxref.y"
              {(yyval.id) = NULL;}
#line 1436 "ourxref.tab.c"
    break;
...
#line 1476 "ourxref.tab.c"
    break;

  case 25:
#line 161 "ourxref.y"
                   {;}
#line 1482 "ourxref.tab.c"
    break;
...
#line 1512 "ourxref.tab.c"
    break;

  case 38:
#line 207 "ourxref.y"
                            {free((yyvsp[0].id));}
#line 1518 "ourxref.tab.c"
    break;

  case 39:
#line 208 "ourxref.y"
                            {free((yyvsp[0].id));}
#line 1524 "ourxref.tab.c"
    break;

  case 40:
#line 209 "ourxref.y"
                            {free((yyvsp[0].id));}
#line 1530 "ourxref.tab.c"
    break;


#line 1534 "ourxref.tab.c"
